...
The router module is made of two base methods, the `route` and `router`. We divide those two to ease extending their behaviour or simply to enable you to use your algorithm without having to sacrifice any parts of our code you want to use.
