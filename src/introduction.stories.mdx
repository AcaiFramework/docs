...
Açai framework aims to be a stack agnsotic framework intended to be used with deno, back or front-end. It aims for simplicity, it should be easy to understand, read and adapt/extend. It's based on a module paradigma, so you can use any parts you wish, removing, adapting, extending or simply letting it be.
