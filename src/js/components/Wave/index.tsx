...
const Wave = (props: Props) => {	
	...
	return (
		<div class={style.container} style={{marginTop: `${props.margin === undefined ? -20:props.margin}vh`}}>
			...
			viewBox="0 24 150 28" preserveAspectRatio="none" shape-rendering="auto">
				...
				<g class={style.parallax}>
					...
					<use xlinkHref="#gentle-wave" x="48" y="7" fill={`${props.color || "var(--bs-primary)"}`} opacity="1" />
				</g>
			</svg>
		</div>
	);
